            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                  <form role="form" action="{{url('')}}/update_user" method="POST">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                    <tr>
                      ...
                      <td><input type=number name=amount value="<?php  echo "$user->amount"; ?>"> </td>
                      <td><input type=text name=location value="<?php  echo "$user->location"; ?>"> </td>
